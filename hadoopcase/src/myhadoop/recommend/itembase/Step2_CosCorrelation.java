...
//全准率：0.25045043 0.27972975	   误差率：1.0401025  0,5,5
/*       0.31256324 0.31328943    0.84960127
* 获取两个项目之间的余弦相似度,余弦值越接近1，就表明夹角越接近0度，也就是两个向量越相似
*/

public class Step2_CosCorrelation {

	 public static class Step2_UserVectorToCosMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {
	    ...
	    public static class Step2_UserVectorToCosReducer extends MapReduceBase implements Reducer<Text, Text, Text, Text> {
	    ...
	    public static void run(Map<String, String> path) throws IOException {
	        ...
	        conf.setMapperClass(Step2_UserVectorToCosMapper.class);       
	        conf.setReducerClass(Step2_UserVectorToCosReducer.class);
