...
//全准率：0.30091187 0.30151978   误差率：1.068725  0,5,5
//       0.28714588               0.90121335
/*
 * 获取两个项目之间的皮尔逊相似度,相关系数的绝对值越大,相关度越大
 */
public class Step2_PearsonCorrelation {  
    public static class Step2_UserVectorToPearsonMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {
    ...
    public static class Step2_UserVectorToPearsonReducer extends MapReduceBase implements Reducer<Text, Text, Text, Text> {
    ...
    public static void run(Map<String, String> path) throws IOException {
        ...
        conf.setMapperClass(Step2_UserVectorToPearsonMapper.class);       
        conf.setReducerClass(Step2_UserVectorToPearsonReducer.class);
