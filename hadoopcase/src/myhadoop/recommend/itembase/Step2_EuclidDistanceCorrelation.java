...
//全准率：0.29841265 0.31865075   误差率：0.952976  0,5,5
/*        0.31198245  0.31230924        0.86163497
* 获取两个项目之间的欧几里得距离,距离越小越好.
*/

public class Step2_EuclidDistanceCorrelation {

	 public static class Step2_UserVectorToEuclidMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {
	    ...
	    public static class Step2_UserVectorToEuclidReducer extends MapReduceBase implements Reducer<Text, Text, Text, Text> {
	    ...
	    public static void run(Map<String, String> path) throws IOException {
	        ...
	        conf.setMapperClass(Step2_UserVectorToEuclidMapper.class);       
	        conf.setReducerClass(Step2_UserVectorToEuclidReducer.class);
